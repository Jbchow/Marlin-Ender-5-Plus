...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 80*60 } // Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define LIN_ADVANCE_K 1.495    // Unit: mm compression per 1mm/s extruder speed
